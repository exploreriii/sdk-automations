...
if (cadenceHours !== null && (!Number.isInteger(cadenceHours) || cadenceHours < 1)) {
    console.error("SWEEP_CADENCE_HOURS must be a whole number of hours, 1 or more.");
    process.exit(1);
}
if (cadenceHours !== null && credentialCount !== 3) {
    console.error(
